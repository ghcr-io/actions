...
[fasthtml](https://fastht.ml) Interact programmatically with  [Actions Artifacts](https://docs.github.com/en/actions/using-workflows/storing-workflow-data-as-artifacts).
...
- [`@actions/artifact`](#actionsartifact.ml)
  - [v2 - What's New](#v2---whats-new.mdx)
    - [Improvements](#improvements.mdx)
    - [Breaking changes](#breaking-changes.md)
  - [Quick Start](#quick-start.md)
  - [Examples](#examples.md)
    - [Upload and Download](#upload-and-download)
    - [Delete an Artifact](#delete-an-artifact)
    - [Downloading from other workflow runs or repos](#downloading-from-other-workflow-runs-or-repos.md)
    - [Speeding up large uploads](#speeding-up-large-uploads.ml)
